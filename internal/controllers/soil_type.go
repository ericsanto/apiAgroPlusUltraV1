...
type SoilTypeController struct {
  ...
  typeSoilService *services.SoilTypeService

}

func NewSoilTypeController (typeSoilService *services.SoilTypeService) *SoilTypeController {
...
func(s *SoilTypeController) PostSoilType(c *gin.Context) {
  ...
  if err := s.typeSoilService.CreateSoilType(soilType); err != nil {
